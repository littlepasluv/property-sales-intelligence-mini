...
class DecisionRecommendation(BaseModel):
    ...
    governance_flags: List[str] = Field(default=[], description="Flags indicating data quality or governance issues related to this recommendation.")
    suggested_owner: SuggestedOwner = Field(..., description="The team or role best suited to execute this action.")
    
    related_confidence_factors: List[str] = Field(default=[], description="Specific confidence drivers (e.g., 'Data Freshness') that influenced this recommendation.")
    explainability_summary: Optional[str] = Field(None, description="A short summary explaining the 'why' behind this specific recommendation.")
